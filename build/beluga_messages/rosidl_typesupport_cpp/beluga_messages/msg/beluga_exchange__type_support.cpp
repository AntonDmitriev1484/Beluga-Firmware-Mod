...
static const _BelugaExchange_type_support_symbol_names_t _BelugaExchange_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, beluga_messages, msg, BelugaExchange)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, beluga_messages, msg, BelugaExchange)),
  }
};
...
{
  return &::beluga_messages::msg::rosidl_typesupport_cpp::BelugaExchange_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, beluga_messages, msg, BelugaExchange)() {
  return get_message_type_support_handle<beluga_messages::msg::BelugaExchange>();
}
