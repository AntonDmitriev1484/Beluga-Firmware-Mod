...
bool beluga_messages__msg__beluga_neighbor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("beluga_messages.msg._beluga_neighbor.BelugaNeighbor", full_classname_dest, 51) == 0);
  }
  beluga_messages__msg__BelugaNeighbor * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of BelugaNeighbor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("beluga_messages.msg._beluga_neighbor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BelugaNeighbor");
